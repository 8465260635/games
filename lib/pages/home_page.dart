...
import 'package:games/pages/game_page.dart';
import 'package:games/widgets/global.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(name,style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.brown.shade700),)
